...
public class ArrayTesting{
	...
	public static void main(String[] args){
		//long arrayTestTime = arrayTest(99999);
		//long arrayListTestTime = arrayListTest(99999);
		long vectorTestTime = vectorTest(175000000);
		//long arrayIterationSum = arrayIteration(99999);
		//long arrayListIterationSum = arrayListIteration(99999);
		long vectorIterationSum = vectorIteration(175000000);
	}
